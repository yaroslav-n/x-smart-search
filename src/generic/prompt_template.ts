...
“exact phrase match” - tweets containing the exact phrase
...
filter:replies – containing replies
...
User input: "${input}"
Return only query. Do not include any other text. Do not use brackets.
`